 ...
 * @since 2026/9/3
 */
public class JsonTextDiffAnywhereAction extends DumbAwareAction implements UpdateInBackground {

    public JsonTextDiffAnywhereAction() {
        super();
        setEnabledInModalContext(true);
        Presentation presentation = getTemplatePresentation();
        presentation.setText(JsonAssistantBundle.message("action.openJsonDiffWindow.text"));
        presentation.setDescription(JsonAssistantBundle.messageOnSystem("action.openJsonDiffWindow.description"));
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        DocumentContent leftDocumentContent = diffContentFactory.createEditable(project, "", fileType);
        ...
        file.putUserData(JsonTextDiffAction.DIFF_REQUEST_KEY, simpleDiffRequest);
