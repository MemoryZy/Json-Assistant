...
public class JsonOldRecord extends BaseNode {
    ...
    public JsonOldRecord() {
    }



    public JsonOldRecord setId(Integer id) {
        this.id = id;
        return this;
    }

    public JsonOldRecord setName(String name) {
        this.name = name;
        return this;
    }

    public JsonOldRecord setDisplayText(String displayText) {
        this.displayText = displayText;
        return this;
    }

    public JsonOldRecord setRawText(String rawText) {
        this.rawText = rawText;
        this.dataSize = StrUtil.isBlank(rawText) ? 0 : rawText.length();
        return this;
    }

    public JsonOldRecord setSourceType(DataFormatType sourceType) {
        this.sourceType = sourceType;
        return this;
    }

    public JsonOldRecord setWrapper(JsonWrapper wrapper) {
        this.wrapper = wrapper;
        return this;
    }

    public JsonOldRecord setCreateTime(Long createTime) {
        this.createTime = createTime;
        return this;
    }

    public JsonOldRecord setUpdateTime(Long updateTime) {
        this.updateTime = updateTime;
        return this;
    }

    public JsonOldRecord setDataSize(Integer dataSize) {
    ...
    public boolean equals(Object o) {
        ...
        JsonOldRecord record = (JsonOldRecord) o;
