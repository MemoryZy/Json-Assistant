...
public class JsonAssistantPlugin {
    ...
    private static final AtomicReference<UpdateInfo> stateHolder =
            new AtomicReference<>(new UpdateInfo(false, null));
    ...
    public static void setUpdateAvailable(boolean hasUpdateAvailable, String latestVersion) {
        // 创建新状态对象并原子更新
        stateHolder.set(new UpdateInfo(hasUpdateAvailable, latestVersion));
    }
    ...
    private static class UpdateInfo {
        ...
        UpdateInfo(boolean updateAvailable, String latestVersion) {
