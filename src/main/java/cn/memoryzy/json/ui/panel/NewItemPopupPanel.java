...
public class NewItemPopupPanel extends JBPanel<NewItemPopupPanel> implements Disposable {
    ...
    public NewItemPopupPanel() {
        this(false);
    }

    public NewItemPopupPanel(boolean liveValidation) {
