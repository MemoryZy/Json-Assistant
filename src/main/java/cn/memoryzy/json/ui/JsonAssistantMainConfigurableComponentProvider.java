...
public class JsonAssistantMainConfigurableComponentProvider {
    ...
    private ComboBox<BackgroundMatchingEnum> backgroundColorBox;
    ...
    private void applyToolWindowAppearanceChunk() {
        ...
        for (BackgroundMatchingEnum value : BackgroundMatchingEnum.values()) {
    ...
    public void reset() {
        ...
        backgroundColorBox.setItem(editorOptionsState.backgroundMatchingEnum);
    ...
    public boolean isModified() {
        ...
        BackgroundMatchingEnum oldBackgroundMatchingEnum = editorOptionsState.backgroundMatchingEnum;
        ...
        BackgroundMatchingEnum backgroundMatchingEnum = backgroundColorBox.getItem();
        ...
        return !Objects.equals(oldIncludeRandomValues, includeRandomValues)
                ...
                || !Objects.equals(oldBackgroundMatchingEnum, backgroundMatchingEnum)
    ...
    public void apply() {
        ...
        editorOptionsState.backgroundMatchingEnum = backgroundColorBox.getItem();
