...
def update_readme(readme_path, start_marker, end_marker, content):
    """保持原有替换逻辑不变"""
...
if __name__ == "__main__":
    ...
    configs = [
        ...
        {
            "readme": "README.md",
            "markers": ("<!-- DONORS_TABLE_EN_START -->", "<!-- DONORS_TABLE_EN_END -->"),
            "headers": ["Name", "Website", "Message", "Amount"],
            "columns": ["name", "website", "message", "total"]
        }
    ]
    ...
    for cfg in configs:
        ...
        update_readme(cfg["readme"], *cfg["markers"], table)